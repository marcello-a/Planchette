...
enum L10n {
    ...
    private static let pt: [LKey: String] = [
        ...
        .minifySidebar: "Recolher barra lateral", .expandSidebar: "Expandir barra lateral", .collapseAllProjects: "Recolher todos os projetos", .expandAllProjects: "Expandir todos os projetos", .peekCollapsedTitle: "Mostrar pedidos sob projetos recolhidos", .peekCollapsedHelp: "Um projeto recolhido continua a mostrar terminais com uma pergunta ou um erro por ler. Desligado, fica totalmente fechado.", .markReady: "Marcar como pronto", .notificationsPanel: "Notificações", .notificationsPanelHelp: "Mostrar o painel de notificações à direita", .onlyActive: "Apenas ativos", .clearReady: "Ocultar inativos", .noProjectsYet: "Ainda sem projetos — clica em + para adicionar um.", .menuCopy: "Copiar", .menuPaste: "Colar", .menuSelectAll: "Selecionar tudo",
