...
enum LKey: String, CaseIterable {
    ...
    // Waiting time
    case secondsShort, minutesShort, hoursShort, daysShort, weeksShort
    ...
    case installTmuxCopy, installTmuxOpen, installTmuxOpenHelp
    ...
    case collapseAllProjects, expandAllProjects
    ...
    case menuCopy, menuPaste, menuSelectAll, menuOpenLink, menuOpenLinkHelp
    ...
    case helpTerminalRowTitle, helpTerminalRowDetail
    case helpActiveMarkTitle, helpActiveMarkDetail
    case markProjectActive, markProjectInactive, markProjectActiveHelp
    case markProjectsActive, markProjectsInactive, inactiveProject
    case newArrangement, overwriteArrangement
    ...
    case deleteArrangementConfirm, deleteArrangementBody
    ...
    // Settings → Project panel (which details the sidebar shows)
    case projectPanelTab, projectPanelShown, projectPanelIntro, projectPanelOptional, projectPanelOptionalHelp
    case detailPath, detailBranch, detailPullRequest, detailTask, detailAge, detailTags, detailNote, detailFinished, detailSnooze, detailAttentionCounts, detailModel, detailContextUsage
    case contextTooltip, helpContextTitle, helpContextDetail
    case detailExample, detailPathHelp, detailBranchHelp, detailPullRequestHelp, detailTaskHelp, detailAgeHelp, detailTagsHelp
    case detailNoteHelp, detailFinishedHelp, detailSnoozeHelp, detailAttentionCountsHelp, detailModelHelp, detailContextUsageHelp
}
...
enum L10n {
    ...
    private static let en: [LKey: String] = [
        ...
        .fontSmaller: "Smaller font", .fontLarger: "Larger font", .fontReset: "Reset font size",
        ...
        .projectPanelTab: "Project panel",
        .projectPanelShown: "Shown in the project panel",
        .projectPanelIntro: "Everything the left panel shows next to a project or a terminal. Turn off what you do not need — the name and the state icon always stay.",
        .projectPanelOptional: "Optional",
        .projectPanelOptionalHelp: "Off by default. They read each Claude terminal's transcript every few seconds while on.",
        .detailPath: "Path of the terminal",
        .detailBranch: "Branch",
        .detailPullRequest: "Pull request",
        .detailTask: "Current prompt",
        .detailAge: "Time since the last change",
        .detailTags: "Tags",
        .detailNote: "Note",
        .detailFinished: "Finished mark",
        .detailSnooze: "Snooze badge",
        .detailAttentionCounts: "Attention counts on projects",
        .detailModel: "Model",
        .detailContextUsage: "Context usage",
        .contextTooltip: "%@ · context %@ of %@ tokens (%d %%)",
        .helpContextTitle: "Context usage and model",
        .helpContextDetail: "At the right edge of a Claude terminal: its model and a ring that fills with the context window — orange from 70 %, red from 90 %, when /compact is due. Off by default; turn it on in Settings → Project panel",
        .detailExample: "Example",
        .detailPathHelp: "The last two folders of the terminal's working directory, next to its name.",
        .detailBranchHelp: "The git branch of the checkout — on the project row while all its terminals share it.",
        .detailPullRequestHelp: "The PR of that branch and its review state. Click it to open the PR. Needs gh.",
        .detailTaskHelp: "The first line of the prompt you last sent this terminal.",
        .detailAgeHelp: "How long the terminal has been in its current state, for questions and errors.",
        .detailTagsHelp: "The tags you put on the terminal, such as \"review\" or \"wip\".",
        .detailNoteHelp: "The note you wrote on the terminal (context menu → Add note).",
        .detailFinishedHelp: "A seal on terminals you marked as finished; the row is also dimmed.",
        .detailSnoozeHelp: "The time a snoozed project or terminal comes back.",
        .detailAttentionCountsHelp: "How many terminals of a project ask (blue), fail (red) or finished unread work (green).",
        .detailModelHelp: "The Claude model the terminal runs on.",
        .detailContextUsageHelp: "How full the context window is — orange from 70 %, red from 90 %.",
    ]
    ...
    private static let de: [LKey: String] = [
        ...
        .fontSmaller: "Kleinere Schrift", .fontLarger: "Größere Schrift", .fontReset: "Schriftgröße zurücksetzen",
        ...
        .projectPanelTab: "Projektleiste",
        .projectPanelShown: "In der Projektleiste angezeigt",
        .projectPanelIntro: "Alles, was die linke Leiste neben einem Projekt oder Terminal zeigt. Schalte ab, was du nicht brauchst — Name und Status-Icon bleiben immer.",
        .projectPanelOptional: "Optional",
        .projectPanelOptionalHelp: "Standardmäßig aus. Solange an, lesen sie alle paar Sekunden das Transkript jedes Claude-Terminals.",
        .detailPath: "Pfad des Terminals",
        .detailBranch: "Branch",
        .detailPullRequest: "Pull Request",
        .detailTask: "Aktueller Prompt",
        .detailAge: "Zeit seit der letzten Änderung",
        .detailTags: "Tags",
        .detailNote: "Notiz",
        .detailFinished: "Fertig-Markierung",
        .detailSnooze: "Schlummer-Badge",
        .detailAttentionCounts: "Status-Zähler an Projekten",
        .detailModel: "Modell",
        .detailContextUsage: "Kontextauslastung",
        .contextTooltip: "%@ · Kontext %@ von %@ Tokens (%d %%)",
        .helpContextTitle: "Kontextauslastung und Modell",
        .helpContextDetail: "Am rechten Rand eines Claude-Terminals: sein Modell und ein Ring, der sich mit dem Kontextfenster füllt — orange ab 70 %, rot ab 90 %, wenn /compact fällig ist. Standardmäßig aus; einschalten unter Einstellungen → Projektleiste",
        .detailExample: "Beispiel",
        .detailPathHelp: "Die letzten zwei Ordner des Arbeitsverzeichnisses, neben dem Namen.",
        .detailBranchHelp: "Der Git-Branch des Checkouts — an der Projektzeile, solange alle Terminals ihn teilen.",
        .detailPullRequestHelp: "Der PR dieses Branches und sein Review-Stand. Klicken öffnet den PR. Braucht gh.",
        .detailTaskHelp: "Die erste Zeile des Prompts, den du diesem Terminal zuletzt geschickt hast.",
        .detailAgeHelp: "Wie lange das Terminal schon im aktuellen Zustand ist, bei Fragen und Fehlern.",
        .detailTagsHelp: "Die Tags am Terminal, etwa „review“ oder „wip“.",
        .detailNoteHelp: "Deine Notiz am Terminal (Kontextmenü → Notiz hinzufügen).",
        .detailFinishedHelp: "Ein Siegel an Terminals, die du als fertig markiert hast; die Zeile wird zudem blasser.",
        .detailSnoozeHelp: "Wann ein schlummerndes Projekt oder Terminal zurückkommt.",
        .detailAttentionCountsHelp: "Wie viele Terminals eines Projekts fragen (blau), Fehler haben (rot) oder ungelesen fertig sind (grün).",
        .detailModelHelp: "Das Claude-Modell, auf dem das Terminal läuft.",
        .detailContextUsageHelp: "Wie voll das Kontextfenster ist — orange ab 70 %, rot ab 90 %.",
    ]
    ...
    private static let fr: [LKey: String] = [
        ...
        .fontSmaller: "Police plus petite", .fontLarger: "Police plus grande", .fontReset: "Réinitialiser la police",
        ...
        .projectPanelTab: "Panneau des projets",
        .projectPanelShown: "Affiché dans le panneau des projets",
        .projectPanelIntro: "Tout ce que le panneau de gauche affiche à côté d’un projet ou d’un terminal. Désactivez ce dont vous n’avez pas besoin — le nom et l’icône d’état restent toujours.",
        .projectPanelOptional: "Optionnel",
        .projectPanelOptionalHelp: "Désactivés par défaut. Activés, ils lisent la transcription de chaque terminal Claude toutes les quelques secondes.",
        .detailPath: "Chemin du terminal",
        .detailBranch: "Branche",
        .detailPullRequest: "Pull request",
        .detailTask: "Prompt en cours",
        .detailAge: "Temps depuis le dernier changement",
        .detailTags: "Tags",
        .detailNote: "Note",
        .detailFinished: "Marque « terminé »",
        .detailSnooze: "Badge de rappel",
        .detailAttentionCounts: "Compteurs d’état des projets",
        .detailModel: "Modèle",
        .detailContextUsage: "Utilisation du contexte",
        .contextTooltip: "%@ · contexte %@ sur %@ tokens (%d %%)",
        .helpContextTitle: "Utilisation du contexte et modèle",
        .helpContextDetail: "Au bord droit d’un terminal Claude : son modèle et un anneau qui se remplit avec la fenêtre de contexte — orange dès 70 %, rouge dès 90 %, quand /compact s’impose. Désactivé par défaut ; à activer dans Réglages → Panneau des projets",
        .detailExample: "Exemple",
        .detailPathHelp: "Les deux derniers dossiers du répertoire du terminal, à côté de son nom.",
        .detailBranchHelp: "La branche git du checkout — sur la ligne du projet tant que tous ses terminaux la partagent.",
        .detailPullRequestHelp: "La PR de cette branche et l’état de sa revue. Un clic ouvre la PR. Nécessite gh.",
        .detailTaskHelp: "La première ligne du dernier prompt envoyé à ce terminal.",
        .detailAgeHelp: "Depuis combien de temps le terminal est dans son état, pour les questions et les erreurs.",
        .detailTagsHelp: "Les tags du terminal, comme « review » ou « wip ».",
        .detailNoteHelp: "La note écrite sur le terminal (menu contextuel → Ajouter une note).",
        .detailFinishedHelp: "Un sceau sur les terminaux marqués terminés ; la ligne est aussi atténuée.",
        .detailSnoozeHelp: "L’heure à laquelle un projet ou un terminal en rappel revient.",
        .detailAttentionCountsHelp: "Combien de terminaux d’un projet demandent (bleu), échouent (rouge) ou ont fini sans être lus (vert).",
        .detailModelHelp: "Le modèle Claude utilisé par le terminal.",
        .detailContextUsageHelp: "Le remplissage de la fenêtre de contexte — orange dès 70 %, rouge dès 90 %.",
    ]
    ...
    private static let es: [LKey: String] = [
        ...
        .fontSmaller: "Fuente más pequeña", .fontLarger: "Fuente más grande", .fontReset: "Restablecer tamaño",
        ...
        .projectPanelTab: "Panel de proyectos",
        .projectPanelShown: "Se muestra en el panel de proyectos",
        .projectPanelIntro: "Todo lo que el panel izquierdo muestra junto a un proyecto o una terminal. Desactiva lo que no necesites: el nombre y el icono de estado se quedan siempre.",
        .projectPanelOptional: "Opcional",
        .projectPanelOptionalHelp: "Desactivados por defecto. Mientras están activos, leen la transcripción de cada terminal de Claude cada pocos segundos.",
        .detailPath: "Ruta de la terminal",
        .detailBranch: "Rama",
        .detailPullRequest: "Pull request",
        .detailTask: "Prompt actual",
        .detailAge: "Tiempo desde el último cambio",
        .detailTags: "Etiquetas",
        .detailNote: "Nota",
        .detailFinished: "Marca de terminado",
        .detailSnooze: "Insignia de recordatorio",
        .detailAttentionCounts: "Contadores de estado en proyectos",
        .detailModel: "Modelo",
        .detailContextUsage: "Uso del contexto",
        .contextTooltip: "%@ · contexto %@ de %@ tokens (%d %%)",
        .helpContextTitle: "Uso del contexto y modelo",
        .helpContextDetail: "En el borde derecho de una terminal de Claude: su modelo y un anillo que se llena con la ventana de contexto — naranja desde 70 %, rojo desde 90 %, cuando toca /compact. Desactivado por defecto; actívalo en Ajustes → Panel de proyectos",
        .detailExample: "Ejemplo",
        .detailPathHelp: "Las dos últimas carpetas del directorio de la terminal, junto a su nombre.",
        .detailBranchHelp: "La rama git del checkout — en la fila del proyecto mientras todas sus terminales la comparten.",
        .detailPullRequestHelp: "La PR de esa rama y su estado de revisión. Un clic abre la PR. Necesita gh.",
        .detailTaskHelp: "La primera línea del último prompt que enviaste a esta terminal.",
        .detailAgeHelp: "Cuánto tiempo lleva la terminal en su estado actual, en preguntas y errores.",
        .detailTagsHelp: "Las etiquetas de la terminal, como «review» o «wip».",
        .detailNoteHelp: "La nota que escribiste en la terminal (menú contextual → Añadir nota).",
        .detailFinishedHelp: "Un sello en las terminales marcadas como terminadas; la fila además se atenúa.",
        .detailSnoozeHelp: "Cuándo vuelve un proyecto o una terminal con recordatorio.",
        .detailAttentionCountsHelp: "Cuántas terminales de un proyecto preguntan (azul), fallan (rojo) o terminaron sin leer (verde).",
        .detailModelHelp: "El modelo de Claude que usa la terminal.",
        .detailContextUsageHelp: "Lo lleno que está la ventana de contexto — naranja desde 70 %, rojo desde 90 %.",
    ]
    ...
    private static let it: [LKey: String] = [
        ...
        .fontSmaller: "Carattere più piccolo", .fontLarger: "Carattere più grande", .fontReset: "Reimposta dimensione",
        ...
        .helpTab: "Aiuto", .helpBranchTitle: "Ramo attivo", .helpBranchDetail: "Il ramo compare sul progetto finché tutti i suoi terminali sono su di esso, altrimenti su ogni terminale", .helpTerminalRowTitle: "Cosa mostra la riga di un terminale", .helpActiveMarkTitle: "Il terminale in cui sei", .helpActiveMarkDetail: "Un bordo nel colore dello stato segna il terminale a schermo; in una divisione, il riquadro attivo", .helpTerminalRowDetail: "Ticket e cartella nella prima riga, il ramo quando i terminali differiscono, poi l'ultimo prompt e quanto tempo fa", .helpSearch: "Cerca funzioni e scorciatoie", .helpNoResults: "Nessun risultato.", .helpMissing: "Manca qualcosa?", .requestFeature: "Proponi una funzione…", .requestFeatureHelp: "Apre una richiesta di funzionalità precompilata su GitHub", .helpSectionTerminals: "Terminali", .helpSectionWindows: "Finestre e navigazione", .helpWhereSidebar: "Barra laterale", .helpWhereTabBar: "Barra dei tab", .helpWhereContextMenu: "Menu contestuale", .helpWhereSettings: "Impostazioni", .helpWhereMenuBar: "Barra dei menu", .helpWhereToolbar: "Barra strumenti", .newProjectInFolderShort: "Nuovo progetto in una cartella", .newProjectInFolderHelp: "Il + su una cartella aggiunge un progetto al suo interno", .folderOverviewTitle: "Panoramica della cartella", .dropIntoFolderHelp: "Trascina un progetto su una cartella, o tra due righe per collocarlo esattamente", .selectedProjectsShort: "Più progetti insieme", .helpMultiSelectDetail: "⌘/⇧-clic seleziona un gruppo; trascinalo o agisci su tutti", .helpClusterTitle: "Vista a griglia", .helpClusterDetail: "Mostra tutti i terminali di un progetto; trascina un riquadro sul bordo di un altro per dividere", .helpDropTitle: "Aprire una cartella dal Finder", .helpCLITitle: "Pilotare Planchette da un agente", .helpCLIDetail: "Un'API su socket e la CLI planchette in ogni terminale: elencare, aprire, inviare, attendere, leggere, leggere le notifiche", .helpInstallOnQuitDetail: "Scarica l'aggiornamento e lo installa alla prossima chiusura, senza interrompere un turno in corso",
        ...
        .projectPanelTab: "Pannello progetti",
        .projectPanelShown: "Mostrato nel pannello progetti",
        .projectPanelIntro: "Tutto ciò che il pannello sinistro mostra accanto a un progetto o a un terminale. Disattiva ciò che non ti serve: nome e icona di stato restano sempre.",
        .projectPanelOptional: "Opzionale",
        .projectPanelOptionalHelp: "Disattivati di default. Quando attivi, leggono la trascrizione di ogni terminale Claude ogni pochi secondi.",
        .detailPath: "Percorso del terminale",
        .detailBranch: "Branch",
        .detailPullRequest: "Pull request",
        .detailTask: "Prompt corrente",
        .detailAge: "Tempo dall’ultima modifica",
        .detailTags: "Tag",
        .detailNote: "Nota",
        .detailFinished: "Segno di finito",
        .detailSnooze: "Badge promemoria",
        .detailAttentionCounts: "Contatori di stato sui progetti",
        .detailModel: "Modello",
        .detailContextUsage: "Uso del contesto",
        .contextTooltip: "%@ · contesto %@ di %@ token (%d %%)",
        .helpContextTitle: "Uso del contesto e modello",
        .helpContextDetail: "Sul bordo destro di un terminale Claude: il suo modello e un anello che si riempie con la finestra di contesto — arancione dal 70 %, rosso dal 90 %, quando serve /compact. Disattivato di default; attivalo in Impostazioni → Pannello progetti",
        .detailExample: "Esempio",
        .detailPathHelp: "Le ultime due cartelle della directory del terminale, accanto al nome.",
        .detailBranchHelp: "Il branch git del checkout — sulla riga del progetto finché tutti i suoi terminali lo condividono.",
        .detailPullRequestHelp: "La PR di quel branch e lo stato della revisione. Un clic apre la PR. Richiede gh.",
        .detailTaskHelp: "La prima riga dell’ultimo prompt inviato a questo terminale.",
        .detailAgeHelp: "Da quanto il terminale è nello stato attuale, per domande ed errori.",
        .detailTagsHelp: "I tag del terminale, come «review» o «wip».",
        .detailNoteHelp: "La nota scritta sul terminale (menu contestuale → Aggiungi nota).",
        .detailFinishedHelp: "Un sigillo sui terminali segnati come finiti; la riga è anche attenuata.",
        .detailSnoozeHelp: "Quando torna un progetto o un terminale in pausa.",
        .detailAttentionCountsHelp: "Quanti terminali di un progetto chiedono (blu), falliscono (rosso) o hanno finito senza lettura (verde).",
        .detailModelHelp: "Il modello Claude usato dal terminale.",
        .detailContextUsageHelp: "Quanto è piena la finestra di contesto — arancione dal 70 %, rosso dal 90 %.",
    ]
    ...
    private static let nl: [LKey: String] = [
        ...
        .fontSmaller: "Kleiner lettertype", .fontLarger: "Groter lettertype", .fontReset: "Lettergrootte herstellen",
        ...
        .helpTab: "Help", .helpBranchTitle: "Uitgecheckte branch", .helpBranchDetail: "De branch staat bij het project zolang al zijn terminals erop zitten, anders bij elke terminal", .helpTerminalRowTitle: "Wat een terminalregel toont", .helpActiveMarkTitle: "De terminal waarin je zit", .helpActiveMarkDetail: "Een rand in de kleur van de status markeert de terminal op het scherm — in een split het gefocuste paneel", .helpTerminalRowDetail: "Ticket en map op de eerste regel, de branch als de terminals verschillen, dan de laatste prompt en hoe lang geleden", .helpSearch: "Zoek functies en sneltoetsen", .helpNoResults: "Niets gevonden.", .helpMissing: "Mis je iets?", .requestFeature: "Functie voorstellen…", .requestFeatureHelp: "Opent een vooringevuld feature request op GitHub", .helpSectionTerminals: "Terminals", .helpSectionWindows: "Vensters & navigatie", .helpWhereSidebar: "Zijbalk", .helpWhereTabBar: "Tabbalk", .helpWhereContextMenu: "Rechtsklikmenu", .helpWhereSettings: "Instellingen", .helpWhereMenuBar: "Menubalk", .helpWhereToolbar: "Werkbalk", .newProjectInFolderShort: "Nieuw project in een map", .newProjectInFolderHelp: "De + op een map maakt daarin een project aan", .folderOverviewTitle: "Mapoverzicht", .dropIntoFolderHelp: "Sleep een project op een map, of tussen twee rijen om het precies te plaatsen", .selectedProjectsShort: "Meerdere projecten tegelijk", .helpMultiSelectDetail: "⌘/⇧-klik kiest een groep; sleep die of pas alles in één keer toe", .helpClusterTitle: "Rasterweergave", .helpClusterDetail: "Alle terminals van een project tegelijk tonen; sleep een paneel naar de rand van een ander om te splitsen", .helpDropTitle: "Een map openen vanuit Finder", .helpCLITitle: "Planchette aansturen vanuit een agent", .helpCLIDetail: "Een socket-API en de planchette-CLI in elke terminal: lijsten, openen, prompten, wachten, lezen, meldingen opvragen", .helpInstallOnQuitDetail: "Downloadt de update en installeert die bij het afsluiten, zonder een lopende beurt te onderbreken",
        ...
        .projectPanelTab: "Projectpaneel",
        .projectPanelShown: "Getoond in het projectpaneel",
        .projectPanelIntro: "Alles wat het linkerpaneel naast een project of terminal toont. Zet uit wat je niet nodig hebt — de naam en het statusicoon blijven altijd.",
        .projectPanelOptional: "Optioneel",
        .projectPanelOptionalHelp: "Standaard uit. Zolang ze aan staan, lezen ze elke paar seconden het transcript van elke Claude-terminal.",
        .detailPath: "Pad van de terminal",
        .detailBranch: "Branch",
        .detailPullRequest: "Pull request",
        .detailTask: "Huidige prompt",
        .detailAge: "Tijd sinds de laatste wijziging",
        .detailTags: "Tags",
        .detailNote: "Notitie",
        .detailFinished: "Klaar-markering",
        .detailSnooze: "Sluimerbadge",
        .detailAttentionCounts: "Statustellers bij projecten",
        .detailModel: "Model",
        .detailContextUsage: "Contextgebruik",
        .contextTooltip: "%@ · context %@ van %@ tokens (%d %%)",
        .helpContextTitle: "Contextgebruik en model",
        .helpContextDetail: "Aan de rechterrand van een Claude-terminal: zijn model en een ring die vol loopt met het contextvenster — oranje vanaf 70 %, rood vanaf 90 %, wanneer /compact nodig is. Standaard uit; zet het aan in Instellingen → Projectpaneel",
        .detailExample: "Voorbeeld",
        .detailPathHelp: "De laatste twee mappen van de werkmap van de terminal, naast de naam.",
        .detailBranchHelp: "De git-branch van de checkout — op de projectrij zolang alle terminals hem delen.",
        .detailPullRequestHelp: "De PR van die branch en de reviewstatus. Klik om de PR te openen. Vereist gh.",
        .detailTaskHelp: "De eerste regel van de prompt die je deze terminal het laatst stuurde.",
        .detailAgeHelp: "Hoe lang de terminal al in zijn huidige status is, bij vragen en fouten.",
        .detailTagsHelp: "De tags van de terminal, zoals ‘review’ of ‘wip’.",
        .detailNoteHelp: "Je notitie bij de terminal (contextmenu → Notitie toevoegen).",
        .detailFinishedHelp: "Een zegel bij terminals die je als klaar markeerde; de rij wordt ook vager.",
        .detailSnoozeHelp: "Wanneer een sluimerend project of terminal terugkomt.",
        .detailAttentionCountsHelp: "Hoeveel terminals van een project vragen (blauw), falen (rood) of ongelezen klaar zijn (groen).",
        .detailModelHelp: "Het Claude-model waarop de terminal draait.",
        .detailContextUsageHelp: "Hoe vol het contextvenster is — oranje vanaf 70 %, rood vanaf 90 %.",
    ]
    ...
    private static let pt: [LKey: String] = [
        ...
        .fontSmaller: "Fonte menor", .fontLarger: "Fonte maior", .fontReset: "Repor tamanho da fonte",
        ...
        .helpTab: "Ajuda", .helpBranchTitle: "Ramo em uso", .helpBranchDetail: "O ramo aparece no projeto enquanto todos os seus terminais estão nele; se diferirem, em cada terminal", .helpTerminalRowTitle: "O que mostra a linha de um terminal", .helpActiveMarkTitle: "O terminal onde estás", .helpActiveMarkDetail: "Um contorno na cor do estado marca o terminal no ecrã — numa divisão, o painel focado", .helpTerminalRowDetail: "Ticket e pasta na primeira linha, o ramo quando os terminais diferem, e o último prompt com a sua idade", .helpSearch: "Procurar funções e atalhos", .helpNoResults: "Nada corresponde.", .helpMissing: "Falta alguma coisa?", .requestFeature: "Sugerir uma função…", .requestFeatureHelp: "Abre um pedido de funcionalidade pré-preenchido no GitHub", .helpSectionTerminals: "Terminais", .helpSectionWindows: "Janelas e navegação", .helpWhereSidebar: "Barra lateral", .helpWhereTabBar: "Barra de separadores", .helpWhereContextMenu: "Menu de contexto", .helpWhereSettings: "Definições", .helpWhereMenuBar: "Barra de menus", .helpWhereToolbar: "Barra de ferramentas", .newProjectInFolderShort: "Novo projeto numa pasta", .newProjectInFolderHelp: "O + numa pasta acrescenta um projeto lá dentro", .folderOverviewTitle: "Vista da pasta", .dropIntoFolderHelp: "Arrasta um projeto para uma pasta, ou entre duas linhas para o colocar exatamente", .selectedProjectsShort: "Vários projetos de uma vez", .helpMultiSelectDetail: "⌘/⇧-clique escolhe um conjunto; arrasta-o ou aplica a todos", .helpClusterTitle: "Vista em grelha", .helpClusterDetail: "Mostrar todos os terminais de um projeto; arrasta um painel para o limite de outro para dividir", .helpDropTitle: "Abrir uma pasta a partir do Finder", .helpCLITitle: "Controlar o Planchette a partir de um agente", .helpCLIDetail: "Uma API por socket e a CLI planchette em cada terminal: listar, abrir, enviar, esperar, ler, consultar as notificações", .helpInstallOnQuitDetail: "Transfere a atualização e instala-a ao sair, sem interromper um turno em curso",
        ...
        .projectPanelTab: "Painel de projetos",
        .projectPanelShown: "Mostrado no painel de projetos",
        .projectPanelIntro: "Tudo o que o painel esquerdo mostra ao lado de um projeto ou terminal. Desligue o que não precisa — o nome e o ícone de estado ficam sempre.",
        .projectPanelOptional: "Opcional",
        .projectPanelOptionalHelp: "Desligados por padrão. Enquanto ligados, leem a transcrição de cada terminal Claude a cada poucos segundos.",
        .detailPath: "Caminho do terminal",
        .detailBranch: "Branch",
        .detailPullRequest: "Pull request",
        .detailTask: "Prompt atual",
        .detailAge: "Tempo desde a última alteração",
        .detailTags: "Tags",
        .detailNote: "Nota",
        .detailFinished: "Marca de concluído",
        .detailSnooze: "Selo de lembrete",
        .detailAttentionCounts: "Contadores de estado nos projetos",
        .detailModel: "Modelo",
        .detailContextUsage: "Uso do contexto",
        .contextTooltip: "%@ · contexto %@ de %@ tokens (%d %%)",
        .helpContextTitle: "Uso do contexto e modelo",
        .helpContextDetail: "Na borda direita de um terminal Claude: o modelo e um anel que enche com a janela de contexto — laranja a partir de 70 %, vermelho a partir de 90 %, quando é hora de /compact. Desligado por padrão; ligue em Ajustes → Painel de projetos",
        .detailExample: "Exemplo",
        .detailPathHelp: "As duas últimas pastas do diretório do terminal, ao lado do nome.",
        .detailBranchHelp: "O branch git do checkout — na linha do projeto enquanto todos os terminais o partilham.",
        .detailPullRequestHelp: "A PR desse branch e o estado da revisão. Um clique abre a PR. Requer gh.",
        .detailTaskHelp: "A primeira linha do último prompt enviado a este terminal.",
        .detailAgeHelp: "Há quanto tempo o terminal está no estado atual, em perguntas e erros.",
        .detailTagsHelp: "As tags do terminal, como «review» ou «wip».",
        .detailNoteHelp: "A nota escrita no terminal (menu de contexto → Adicionar nota).",
        .detailFinishedHelp: "Um selo nos terminais marcados como concluídos; a linha também fica esbatida.",
        .detailSnoozeHelp: "Quando um projeto ou terminal adiado volta.",
        .detailAttentionCountsHelp: "Quantos terminais de um projeto perguntam (azul), falham (vermelho) ou terminaram sem leitura (verde).",
        .detailModelHelp: "O modelo Claude em que o terminal corre.",
        .detailContextUsageHelp: "Quão cheia está a janela de contexto — laranja a partir de 70 %, vermelho a partir de 90 %.",
    ]
}
