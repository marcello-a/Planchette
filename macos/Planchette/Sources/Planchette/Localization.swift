...
enum LKey: String, CaseIterable {
    ...
    case folderOverviewHelp, folderEmpty, openProjectHelp, terminalsCount
...
enum L10n {
    ...
    private static let en: [LKey: String] = [
        ...
        .folderOverviewHelp: "Show what is inside this folder", .folderEmpty: "No projects in this folder yet — drag one in from the sidebar.", .openProjectHelp: "Open this project", .terminalsCount: "%d terminals", .latestNotifications: "Latest notifications", .nothingReported: "Nothing reported yet",
    ...
    private static let de: [LKey: String] = [
        ...
        .folderOverviewHelp: "Zeigen, was in diesem Ordner steckt", .folderEmpty: "Noch keine Projekte in diesem Ordner — eines aus der Seitenleiste hineinziehen.", .openProjectHelp: "Projekt öffnen", .terminalsCount: "%d Terminals", .latestNotifications: "Neueste Benachrichtigungen", .nothingReported: "Noch nichts gemeldet",
    ...
    private static let fr: [LKey: String] = [
        ...
        .folderOverviewHelp: "Afficher le contenu de ce dossier", .folderEmpty: "Aucun projet dans ce dossier — glissez-en un depuis la barre latérale.", .openProjectHelp: "Ouvrir ce projet", .terminalsCount: "%d terminaux", .latestNotifications: "Dernières notifications", .nothingReported: "Rien à signaler pour l'instant",
    ...
    private static let es: [LKey: String] = [
        ...
        .folderOverviewHelp: "Muestra lo que hay en esta carpeta", .folderEmpty: "Aún no hay proyectos en esta carpeta — arrastra uno desde la barra lateral.", .openProjectHelp: "Abrir este proyecto", .terminalsCount: "%d terminales", .latestNotifications: "Últimas notificaciones", .nothingReported: "Nada que informar todavía",
    ...
    private static let it: [LKey: String] = [
        ...
        .folderOverviewHelp: "Mostra cosa c'è in questa cartella", .folderEmpty: "Nessun progetto in questa cartella — trascinane uno dalla barra laterale.", .openProjectHelp: "Apri questo progetto", .terminalsCount: "%d terminali", .latestNotifications: "Ultime notifiche", .nothingReported: "Ancora nessuna segnalazione",
    ...
    private static let nl: [LKey: String] = [
        ...
        .folderOverviewHelp: "Laat zien wat er in deze map zit", .folderEmpty: "Nog geen projecten in deze map — sleep er een vanuit de zijbalk in.", .openProjectHelp: "Dit project openen", .terminalsCount: "%d terminals", .latestNotifications: "Nieuwste meldingen", .nothingReported: "Nog niets gemeld",
    ...
    private static let pt: [LKey: String] = [
        ...
        .folderOverviewHelp: "Mostrar o que está nesta pasta", .folderEmpty: "Ainda não há projetos nesta pasta — arrasta um da barra lateral.", .openProjectHelp: "Abrir este projeto", .terminalsCount: "%d terminais", .latestNotifications: "Notificações mais recentes", .nothingReported: "Ainda nada reportado",
