...
enum L10n {
    ...
    private static let en: [LKey: String] = [
        ...
        .arrangements: "Arrangements", .arrangementsHelp: "Saved arrangements of projects and terminals", .saveArrangement: "Save arrangement…", .saveArrangementTitle: "Name of the arrangement", .newArrangement: "New arrangement…", .overwriteArrangement: "Overwrite \"%@\"", .saveArrangementHelp: "Save this window's projects and terminals as a reusable arrangement", .openArrangement: "Open", .renameArrangement: "Rename arrangement", .deleteArrangement: "Delete arrangement", .noArrangements: "No saved arrangements yet", .arrangementSummary: "%d projects · %d terminals", .savedArrangements: "Saved arrangements",
    ...
    private static let de: [LKey: String] = [
        ...
        .arrangements: "Anordnungen", .arrangementsHelp: "Gespeicherte Anordnungen von Projekten und Terminals", .saveArrangement: "Anordnung speichern…", .saveArrangementTitle: "Name der Anordnung", .newArrangement: "Neue Anordnung…", .overwriteArrangement: "\"%@\" überschreiben", .saveArrangementHelp: "Projekte und Terminals dieses Fensters als wiederverwendbare Anordnung speichern", .openArrangement: "Öffnen", .renameArrangement: "Anordnung umbenennen", .deleteArrangement: "Anordnung löschen", .noArrangements: "Noch keine Anordnungen gespeichert", .arrangementSummary: "%d Projekte · %d Terminals", .savedArrangements: "Gespeicherte Anordnungen",
    ...
    private static let fr: [LKey: String] = [
        ...
        .arrangements: "Agencements", .arrangementsHelp: "Agencements enregistrés de projets et de terminaux", .saveArrangement: "Enregistrer l’agencement…", .saveArrangementTitle: "Nom de l’agencement", .newArrangement: "Nouvel agencement…", .overwriteArrangement: "Remplacer « %@ »", .saveArrangementHelp: "Enregistrer les projets et terminaux de cette fenêtre comme agencement réutilisable", .openArrangement: "Ouvrir", .renameArrangement: "Renommer l’agencement", .deleteArrangement: "Supprimer l’agencement", .noArrangements: "Aucun agencement enregistré", .arrangementSummary: "%d projets · %d terminaux", .savedArrangements: "Agencements enregistrés",
