...
enum L10n {
    ...
    private static let en: [LKey: String] = [
        ...
        .folderOverviewHelp: "Show what is inside this folder", .folderEmpty: "No projects in this folder yet — drag one in from the sidebar.", .openProjectHelp: "Open this project", .terminalsCount: "%d terminals", .terminalCountOne: "1 terminal", .latestNotifications: "Latest notifications", .nothingReported: "Nothing reported yet",
    ...
    private static let nl: [LKey: String] = [
        ...
        .folderOverviewHelp: "Laat zien wat er in deze map zit", .folderEmpty: "Nog geen projecten in deze map — sleep er een vanuit de zijbalk in.", .openProjectHelp: "Dit project openen", .terminalsCount: "%d terminals", .terminalCountOne: "1 terminal", .latestNotifications: "Nieuwste meldingen", .nothingReported: "Nog niets gemeld",
    ...
    private static let pt: [LKey: String] = [
        ...
        .folderOverviewHelp: "Mostrar o que está nesta pasta", .folderEmpty: "Ainda não há projetos nesta pasta — arrasta um da barra lateral.", .openProjectHelp: "Abrir este projeto", .terminalsCount: "%d terminais", .terminalCountOne: "1 terminal", .latestNotifications: "Notificações mais recentes", .nothingReported: "Ainda nada reportado",
