...
enum Help {
    ...
    static let sections: [Section] = [
        Section(titleKey: .projects, entries: [
            ...
            Entry(.projectPanelTab, .projectPanelIntro, where: .helpWhereSettings),
        ...
        Section(titleKey: .helpSectionTerminals, entries: [
            ...
            Entry(.fontLarger, nil, shortcut: "⌘+", where: .helpWhereContextMenu),
            Entry(.fontSmaller, nil, shortcut: "⌘-", where: .helpWhereContextMenu),
            Entry(.fontReset, nil, shortcut: "⌘0", where: .helpWhereContextMenu),
            ...
            Entry(.helpContextTitle, .helpContextDetail, where: .helpWhereSettings),
